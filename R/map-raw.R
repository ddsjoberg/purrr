...
map_raw <- function(.x, .f, ...) {
  lifecycle::deprecate_stop("1.0.0", "map_raw()", "map_vec()")
  map_("raw", .x, .f, ...)
}
...
map2_raw <- function(.x, .y, .f, ...) {
  lifecycle::deprecate_stop("1.0.0", "map2_raw()", "map2_vec()")
  map2_("raw", .x, .y, .f, ...)
}
...
imap_raw <- function(.x, .f, ...) {
  lifecycle::deprecate_stop("1.0.0", "imap_raw()", "imap_vec()")
...
pmap_raw <- function(.l, .f, ...) {
  lifecycle::deprecate_stop("1.0.0", "pmap_raw()", "pmap_vec()")
  pmap_("raw", .l, .f, ...)
}
...
flatten_raw <- function(.x) {
  lifecycle::deprecate_stop("1.0.0", "flatten_raw()")
